...
echo " -------------------------------------------------------------------------"
echo "${txtylw}	Welcome to Apt-fetcher version 0.3. ${txtrst}"
echo ".........................................................................."
...
dpkg -l | grep '^ii' | awk '{print $2 "\t" $3}' >> /opt/installed_packages.txt
echo "\n"
echo "See /opt/installed_packages.txt"
echo "You can remove the file with: sudo rm -r /opt/installed_packages.txt"
sleep 2
sh /usr/share/apt.sh
